<template>
  <div :class="wrapClasses">
    <template v-if="type !== 'textarea'">
      ...
      <i
        class="bee-sys-icon"
        :class="['' + icon, prefixCls + '-icon', prefixCls + '-icon-normal']"
        v-else-if="icon"
        @click="handleIconClick"
      ></i>
      <i
        class="bee-sys-icon ios-search"
        :class="[
          prefixCls + '-icon',
          prefixCls + '-icon-normal',
        ...
        @click="handleSearch"
      ></i>
      <span class="bee-input-suffix" v-else-if="showSuffix">
        <slot name="suffix">
          <i class="bee-sys-icon" :class="['' + suffix]" v-if="suffix"></i>
        </slot>
      </span>
      <span class="bee-input-word-count" v-else-if="showWordLimit"
        >{{ textLength }}/{{ upperLimit }}</span
      >
      <span
        class="bee-input-suffix"
        v-else-if="password"
        @click="handleToggleShowPassword"
      >
        <i class="bee-sys-icon ios-eye-off-outline" v-if="showPassword"></i>
        <i class="bee-sys-icon ios-eye-outline" v-else></i>
      </span>
      <transition name="fade">
        <i
          class="bee-sys-icon ios-loading bee-load-loop"
      ...
      <div
        ...
        @click="handleSearch"
      >
        <i class="bee-sys-icon ios-search" v-if="enterButton === true"></i>
        <template v-else>{{ enterButton }}</template>
      </div>
      <span class="bee-input-prefix" v-else-if="showPrefix">
        <slot name="prefix">
          <i class="bee-sys-icon" :class="['' + prefix]" v-if="prefix"></i>
        </slot>
      </span>
    </template>
    <template v-else>
      <textarea
        ...
        @input="handleInput"
      ></textarea>
      <span class="bee-input-word-count" v-if="showWordLimit"
        >{{ textLength }}/{{ upperLimit }}</span
      >
    </template>
  </div>
