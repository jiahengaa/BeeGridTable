...
const prefixCls = "bee-input-number";
const iconPrefixCls = "bee-sys-icon ";
...
export default {
    ...
    computed: {
        ...
        innerUpClasses() {
            return `${prefixCls}-handler-up-inner ${iconPrefixCls}`;
        },
        downClasses() {
            return [
                `${prefixCls}-handler`,
        ...
        innerDownClasses() {
            return `${prefixCls}-handler-down-inner ${iconPrefixCls} `;
        },
        inputWrapClasses() {
